...
public class Responsive_Testing {
	...
	public Object[][] mobileEmulation() {
		return new Object[][] {
				  ...
				  {320, 480, 40, "Iphone 4" }, {320, 480, 40, "Iphone 4" }, {414, 896, 50,
				  "Iphone XR" }, {390, 844, 50, "Iphone 12 pro" }, {820, 1180, 40, "Ipad Air"
				  ...
				  {412,915,57,"Galaxy S20 Ultra"}, {280,653,79,"Galaxy Fold"}, {412,
				  914,50,"Galaxy A51 & A71"}, {240,320,100,"JioPhone"},
	...
	public void mhrcm_Ui_test(int a, int b, int c, String name) throws InterruptedException, IOException {
		System.setProperty("webdriver.gecko.driver",
				"C:\\Users\\Dinesh K\\eclipse-workspace\\Java_Testing\\driver\\geckodriver.exe");
		FirefoxDriver driver = new FirefoxDriver();
		driver.manage().window().maximize();
		DevTools devtool = driver.getDevTools();
		devtool.createSession();
		devtool.send(Emulation.setDeviceMetricsOverride(a, b, c, true, Optional.empty(), Optional.empty(),
		...
		if (j.executeScript("return document.readyState").toString().equals("complete")) {
			...
			FileHandler.copy(src,
					new File("C:\\Users\\Dinesh K\\eclipse-workspace\\Java_Testing\\Screenshots\\" + name + ".png"));
		} else {
